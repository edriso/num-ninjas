...
export const level2Questions: QuestionSeed[] = [
  ...
  // Topic 1 - MCQ 1
  {
    ...
    questionText: 'أحمد أكل ٣/٨ من البيتزا وصاحبه أكل ٢/٨. أكلوا قد إيه مع بعض؟',
  ...
  // Topic 1 - MCQ 2
  {
    ...
    questionText: 'سارة أكلت ٤/٦ من الكيكة وأختها أكلت ١/٦. فاضل قد إيه من الكيكة؟',
    hintText: 'اجمع اللي اتاكل الأول وبعدين اطرح من الواحد الصحيح',
    explanation: '٤/٦ + ١/٦ = ٥/٦ اتاكلوا، فالفاضل = ٦/٦ - ٥/٦ = ١/٦',
    options: [
  ...
  // Topic 1 - MCQ 3
  {
    ...
    questionText: 'لو شربت ٣/٥ من العصير، محتاج تشرب كمان قد إيه عشان تخلّص الكل؟',
    hintText: 'الكل = ٥/٥، اطرح منه اللي شربته',
    explanation: '٥/٥ - ٣/٥ = ٢/٥ هو اللي فاضل',
    options: [
  ...
  // Topic 1 - MCQ 4
  {
    ...
    questionText: 'مريم لونت ٢/١٠ أزرق و ٥/١٠ أحمر. لونت قد إيه من اللوحة كلها؟',
  ...
  // Topic 1 - MCQ 6
  {
    topicIndex: 1,
    questionType: 'mcq',
    realLifeContext: 'نور بتقسم شريط ملون ٨ أجزاء متساوية عشان تعمل أساور',
    questionText: 'نور استخدمت ٥/٨ من الشريط. لو قصت كمان ١/٨، يفضل قد إيه؟',
  ...
  // Topic 1 - MCQ 8
  {
    ...
    questionText: 'كريم أكل ١/٣ وخالد أكل ١/٣. الفاضل قد إيه؟',
    hintText: 'اجمع اللي اتاكل واطرح من الكل',
    explanation: '١/٣ + ١/٣ = ٢/٣ اتاكلوا، فالفاضل = ٣/٣ - ٢/٣ = ١/٣',
    options: [
  ...
  // Topic 1 - Open Ended 1
  {
    ...
    questionText: 'ياسمين أكلت ٢/٥ وأختها أكلت ١/٥. فاضل كام على ٥ من الشوكولاتة؟',
    hintText: 'اجمع اللي اتاكل واطرح من ٥/٥',
    explanation: '٢/٥ + ١/٥ = ٣/٥ اتاكلوا. الفاضل = ٥/٥ - ٣/٥ = ٢/٥. البسط = ٢',
    correctAnswer: '٢',
  ...
  // Topic 1 - Open Ended 2
  {
    ...
    questionText: 'لو أكلت ٣/٤ من الساندوتش، اطرح من الكل. البسط بتاع الفاضل كام؟',
    hintText: '٤/٤ - ٣/٤ = ؟/٤',
  ...
  // Topic 2 - MCQ 1
  {
    ...
    questionText: 'سعر اللبن ٧٫٥٠ جنيه وسعر العصير ٧٫٢٥ جنيه. أنهي أغلى؟',
  ...
  // Topic 2 - MCQ 5
  {
    ...
    questionText: 'القلم بـ ٣٫٧٥ جنيه والكراسة بـ ٥٫٢٠ جنيه. أنهي أغلى وبكام فرق؟',
  ...
  // Topic 2 - MCQ 7
  {
    ...
    questionText: 'أنهي عدد أكبر: ٤٫٠٨ ولا ٤٫٨٠؟',
  ...
  // Topic 2 - Open Ended 4
  {
    ...
    questionText: 'عند ياسمين ٨٫٥٠ جنيه. اشترت ساندوتش بـ ٥٫٢٥ جنيه. فاضل معاها كام؟',
  ...
  // Topic 3 - MCQ 2
  {
    topicIndex: 3,
    questionType: 'mcq',
    realLifeContext: 'سارة معاها فلوس وراحت المكتبة تشتري كتاب',
    questionText: 'سارة معاها ٢٠٫٠٠ جنيه واشترت كتاب بـ ١٤٫٥٠ جنيه. الباقي كام؟',
    hintText: 'اطرح سعر الكتاب من الفلوس',
  ...
  // Topic 3 - MCQ 8
  {
    topicIndex: 3,
    questionType: 'mcq',
    realLifeContext: 'ياسمين بتجمع فلوس في الحصالة',
    questionText: 'كان فيها ٢٥٫٤٠ جنيه وحطت ١٢٫٦٠ جنيه كمان. المجموع كام؟',
  ...
  // Topic 3 - Open Ended 4
  {
    ...
    questionText: 'فاتورة الشهر ده ٨٥٫٤٠ جنيه والشهر اللي فات ٧٩٫٦٠ جنيه. مجموع الشهرين كام؟',
  ...
  // Topic 4 - MCQ 1
  {
    topicIndex: 4,
    questionType: 'mcq',
    realLifeContext: 'أحمد بيروح المدرسة كل يوم الصبح',
  ...
  // Topic 4 - MCQ 3
  {
    ...
    hintText: 'من ٩:٠٠ لـ ١٠:٠٠ = ساعة، وكمان ٤٥ دقيقة',
  ...
  // Topic 4 - MCQ 8
  {
    topicIndex: 4,
    questionType: 'mcq',
    realLifeContext: 'مريم بتطبخ مع ماما وعايزة تعرف الأكل يخلص امتى',
    questionText: 'حطوا الأكل في الفرن الساعة ٥:٤٠ ومحتاج ساعة و ٢٠ دقيقة. يطلع الساعة كام؟',
    hintText: '٥:٤٠ + ١ ساعة = ٦:٤٠، وكمان ٢٠ دقيقة',
  ...
  // Topic 4 - Open Ended 1
  {
    topicIndex: 4,
    questionType: 'open_ended',
    realLifeContext: 'عمر بيروح تمرين كورة القدم',
  ...
  // Topic 4 - Open Ended 2
  {
    ...
    questionText: 'القطر بيمشي الساعة ١٦:٤٥ بنظام ٢٤ ساعة. ده يبقى كام بنظام ١٢ ساعة؟ اكتب الساعة بس.',
  ...
  // Topic 4 - Open Ended 4
  {
    ...
    questionText: 'الأتوبيس بيعدي عليه ٦:٥٠ الصبح والمدرسة بتبدأ ٧:٣٠. بيوصل قبل المدرسة بكام دقيقة لو الطريق ٢٥ دقيقة؟',
  ...
  // Topic 5 - MCQ 2
  {
    topicIndex: 5,
    questionType: 'mcq',
    realLifeContext: 'سارة عايزة تفرش أوضتها بسجادة',
  ...
  // Topic 5 - MCQ 4
  {
    topicIndex: 5,
    questionType: 'mcq',
    realLifeContext: 'نور عايزة تعمل إطار لصورة مربعة',
  ...
  // Topic 5 - MCQ 6
  {
    topicIndex: 5,
    questionType: 'mcq',
    realLifeContext: 'المدرسة عايزة تعمل سور حوالين حديقة المدرسة',
  ...
  // Topic 5 - MCQ 7
  {
    topicIndex: 5,
    questionType: 'mcq',
    realLifeContext: 'مريم عايزة تدهن حيطة أوضتها',
  ...
  // Topic 5 - Open Ended 2
  {
    topicIndex: 5,
    questionType: 'open_ended',
    realLifeContext: 'ياسمين عايزة تعمل برواز حوالين لوحة مربعة',
