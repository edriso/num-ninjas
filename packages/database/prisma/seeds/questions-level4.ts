...
export const level4Questions: QuestionSeed[] = [
  ...
  // --- Topic 2, MCQ 2 ---
  {
    topicIndex: 2,
    questionType: 'mcq',
    realLifeContext: 'موبايل سارة البطارية خاصته 100٪ الصبح. استخدمت 35٪ لحد الضهر.',
  ...
  // --- Topic 2, MCQ 3 ---
  {
    topicIndex: 2,
    questionType: 'mcq',
    realLifeContext: 'باقة النت خاصتك 20 جيجا. استخدمت 15 جيجا هذا الشهر.',
  ...
  // --- Topic 5, MCQ 2 ---
  {
    topicIndex: 5,
    questionType: 'mcq',
    realLifeContext: 'وزّع المدرس أقلام على الطلاب. كل طالب أخذ 3 أقلام والمجموع 24 قلم.',
  ...
  // --- Topic 5, MCQ 3 ---
  {
    ...
    questionText: 'العيدية كانت كم؟ (حل: س + 8 = 20)',
  ...
  // --- Topic 5, MCQ 4 ---
  {
    ...
    questionText: 'سعر الكيس الواحد كم؟ (حل: 5س = 35)',
  ...
  // --- Topic 5, Open-ended 2 ---
  {
    ...
    questionText: 'سعر القلم الواحد كم؟ (حل: 6س = 48)',
    correctAnswer: '8',
  ...
  // --- Topic 5, Open-ended 3 ---
  {
    ...
    questionText: 'مصروف اليوم كان كم؟ (حل: س + 11 = 26)',
    correctAnswer: '15',
  ...
  // --- Topic 5, Open-ended 4 ---
  {
    ...
    questionText: 'سعر التذكرة الواحدة كم؟ (حل: 7س = 56)',
    correctAnswer: '8',
    correctAnswerNumeric: 8,
  ...
  // --- Topic 6, Open-ended 4 ---
  {
    ...
    questionText: 'الرحلة أخذت كم ساعة؟',
    correctAnswer: '3',
    correctAnswerNumeric: 3,
    hintText: 'الزمن = المسافة ÷ السرعة',
