...
export const level5Questions: QuestionSeed[] = [
  ...
  // --- Topic 1, MCQ 2 ---
  {
    topicIndex: 1,
    questionType: 'mcq',
    realLifeContext: 'بابا بيشرح لك إن البكتيريا بتتضاعف. كل ساعة عددها بيتضرب في 3.',
    questionText: 'لو بدأنا بـ 1 بكتيريا، بعد 4 ساعات هيكون كام؟ (3⁴)',
    hintText: '3 × 3 × 3 × 3',
  ...
  // --- Topic 1, MCQ 7 ---
  {
    ...
    questionText: 'أي عدد لو رفعناه للأُس صفر بيساوي كام؟ مثلاً 7⁰ = ؟',
  ...
  // --- Topic 4, MCQ 1 ---
  {
    ...
    questionText: 'احتمال يطلع رقم 6 هو كام؟',
  ...
  // --- Topic 4, MCQ 4 ---
  {
    ...
    questionType: 'mcq',
    realLifeContext: 'رميت زهر (نرد) مرة واحدة.',
    questionText: 'احتمال يطلع رقم فردي (1 أو 3 أو 5) كام؟',
  ...
  // --- Topic 4, MCQ 6 ---
  {
    ...
    questionText: 'احتمال مجموع زهرين يساوي 7 هو كام؟',
  ...
  // --- Topic 4, MCQ 7 ---
  {
    ...
    questionText: 'احتمال تسحب كرة رقمها يقبل القسمة على 3 كام؟',
  ...
  // --- Topic 6, MCQ 2 ---
  {
    ...
    questionText: 'لو 2س + 5 = 17، عمر أخوه (س) كام؟',
  ...
  // --- Topic 6, MCQ 3 ---
  {
    ...
    questionText: 'لو 3س + 4 = 25، كم قطعة أخد كل طفل (س)؟',
  ...
  // --- Topic 6, MCQ 4 ---
  {
    ...
    questionText: 'لو 4س - 10 = 50، سعر اللعبة الواحدة (س) كام؟',
  ...
  // --- Topic 6, MCQ 5 ---
  {
    ...
    questionText: 'لو 5س - 8 = 27، العدد (س) كام؟',
  ...
  // --- Topic 6, MCQ 6 ---
  {
    ...
    questionText: 'لو عمر الأخت = س وعمر سارة = س + 4، يكون 2س + 4 = 28. عمر الأخت كام؟',
  ...
  // --- Topic 6, MCQ 8 ---
  {
    ...
    questionText: 'لو 6س + 5 = 47، سعر الكراسة (س) كام؟',
  ...
  // --- Topic 6, Open-ended 1 ---
  {
    ...
    questionText: 'لو 7س + 11 = 67، العدد (س) كام؟',
    correctAnswer: '8',
  ...
  // --- Topic 6, Open-ended 2 ---
  {
    ...
    questionText: 'لو 3س - 20 = 100، سعر التيشيرت (س) كام؟',
    correctAnswer: '40',
    correctAnswerNumeric: 40,
  ...
  // --- Topic 6, Open-ended 3 ---
  {
    ...
    questionText: 'عمر علي كام؟ (س + س + 26 = 50)',
    correctAnswer: '12',
  ...
  // --- Topic 7, MCQ 1 ---
  {
    ...
    questionText: 'العدد اللي بعد 54 في النمط هذا كام؟',
  ...
  // --- Topic 7, MCQ 3 ---
  {
    ...
    questionText: 'العدد اللي بعد 13 كام؟ (فيبوناتشي)',
  ...
  // --- Topic 7, MCQ 5 ---
  {
    ...
    questionText: 'العدد اللي بعد 125 كام؟',
  ...
  // --- Topic 7, MCQ 7 ---
  {
    ...
    questionText: 'العدد اللي بعد 25 كام؟',
  ...
  // --- Topic 7, MCQ 8 ---
  {
    ...
    questionText: 'العدد الناقص على نفس الضلع (1 + ؟ + 5 = 12) كام؟',
    hintText: '12 - 1 - 5 = ؟',
  ...
  // --- Topic 7, Open-ended 1 ---
  {
    ...
    questionText: 'العدد اللي بعد 81 كام؟',
    correctAnswer: '243',
