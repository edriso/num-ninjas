...
export const level2Questions: QuestionSeed[] = [
  ...
  // Topic 1 - MCQ 5
  {
    ...
    questionText: 'طارق حل ٣/٤ من التمارين الصبح و ١/٤ بالليل. حل كم من التمارين؟',
  ...
  // Topic 1 - MCQ 6
  {
    ...
    questionText: 'نور استخدمت ٥/٨ من الشريط. لو قصت أيضاً ١/٨، يتبقى قد إيه؟',
  ...
  // Topic 1 - Open Ended 1
  {
    ...
    realLifeContext: 'ياسمين تأكل فواكه مقسومة ٥ مربعات',
    questionText: 'ياسمين أكلت ٢/٥ وأختها أكلت ١/٥. كم يتبقى على ٥ من الفواكه؟',
  ...
  // Topic 2 - MCQ 5
  {
    ...
    questionText: 'القلم بـ ٣٫٧٥ جنيه والكراسة بـ ٥٫٢٠ جنيه. أي أغلى وبكم فرق؟',
  ...
  // Topic 2 - MCQ 8
  {
    ...
    questionText: 'العدد ٠٫٧ يساوي كم من عشرة؟',
  ...
  // Topic 2 - Open Ended 2
  {
    ...
    questionText: 'وزن الشنطة ٣٫٤ كجم ووزن اللانش بوكس ١٫٢ كجم. مين أتقل بكم كجم؟',
  ...
  // Topic 3 - MCQ 6
  {
    ...
    questionText: 'وزن نور كان ٤٥٫٨ كجم وبقى ٤٣٫٥ كجم. نقصت كم كجم؟',
  ...
  // Topic 3 - MCQ 7
  {
    ...
    questionText: 'أحمد قفز ٣٫٢٥ متر وعمر قفز ٢٫٩٠ متر. الفرق كم متر؟',
  ...
  // Topic 3 - Open Ended 1
  {
    ...
    questionText: 'ألوان بـ ١٥٫٣٠ جنيه وفرشاة بـ ٧٫٥٠ جنيه. المجموع كم جنيه؟',
  ...
  // Topic 3 - Open Ended 2
  {
    ...
    questionText: 'معاه ١٠٫٠٠ جنيه واشترى عصير بـ ٣٫٢٥ جنيه وموز بـ ٢٫٥٠ جنيه. الباقي كام؟',
  ...
  // Topic 3 - Open Ended 3
  {
    ...
    questionText: 'طوله السنة دي ١٤٢٫٥ سم والسنة اللي فاتت كان ١٣٨٫٨ سم. طال كم سم؟',
  ...
  // Topic 4 - MCQ 6
  {
    ...
    questionText: 'اليوم الدراسي بيبدأ ٧:٣٠ الصبح وبيخلص ١:٣٠ الضهر. مدته كم ساعة؟',
  ...
  // Topic 4 - MCQ 7
  {
    ...
    questionText: 'الساعة ١٤:٠٠ بنظام ٢٤ ساعة يعني كم بنظام ١٢ ساعة؟',
  ...
  // Topic 4 - Open Ended 1
  {
    ...
    questionText: 'التمرين بيبدأ ٣:٣٠ وبيخلص ٥:١٥. مدة التمرين كم دقيقة؟',
  ...
  // Topic 4 - Open Ended 2
  {
    ...
    questionText: 'القطر بيمشي الساعة ١٦:٤٥ بنظام ٢٤ ساعة. هذا يكون كم بنظام ١٢ ساعة؟ اكتب الساعة بس.',
    hintText: 'اطرح ١٢ من ١٦',
    explanation: '١٦ - ١٢ = ٤، يكون الساعة ٤:٤٥ مساءً',
    correctAnswer: '٤:٤٥',
  ...
  // Topic 4 - Open Ended 3
  {
    ...
    questionText: 'بدأ المذاكرة ٤:٠٠ العصر وخلّص ٦:٣٠. ذاكر كم دقيقة؟',
  ...
  // Topic 4 - Open Ended 4
  {
    ...
    questionText: 'الأتوبيس يمر عليه ٦:٥٠ الصبح والمدرسة بتبدأ ٧:٣٠. بيوصل قبل المدرسة بكم دقيقة لو الطريق ٢٥ دقيقة؟',
  ...
  // Topic 5 - MCQ 1
  {
    ...
    questionText: 'أوضة أحمد طولها ٤ متر وعرضها ٣ متر. محيط الأوضة كم متر؟',
  ...
  // Topic 5 - MCQ 2
  {
    ...
    questionText: 'أوضة سارة طولها ٥ متر وعرضها ٤ متر. مساحة الأوضة كم متر مربع؟',
  ...
  // Topic 5 - MCQ 3
  {
    ...
    questionText: 'ملعب صغير طوله ٢٠ متر وعرضه ١٠ متر. مساحته كم متر مربع؟',
  ...
  // Topic 5 - MCQ 4
  {
    ...
    questionText: 'صورة مربعة طول ضلعها ٦ متر. محيطها كم متر؟',
  ...
  // Topic 5 - MCQ 5
  {
    ...
    questionText: 'الحوش مربع طول ضلعه ٨ متر. مساحته كم متر مربع؟',
  ...
  // Topic 5 - MCQ 6
  {
    ...
    questionText: 'الحديقة مستطيلة طولها ١٥ متر وعرضها ١٠ متر. محتاجين كم متر سور؟',
  ...
  // Topic 5 - MCQ 7
  {
    ...
    questionText: 'الحيطة طولها ٥ متر وارتفاعها ٣ متر. مساحة الحيطة كم متر مربع؟',
  ...
  // Topic 5 - Open Ended 1
  {
    ...
    questionText: 'الصالة مستطيلة طولها ٦ متر وعرضها ٤ متر. مساحتها كم متر مربع؟',
    hintText: 'المساحة = الطول × العرض',
  ...
  // Topic 5 - Open Ended 2
  {
    ...
    questionText: 'اللوحة مربعة طول ضلعها ٧ متر. محيطها كم متر؟',
  ...
  // Topic 5 - Open Ended 3
  {
    ...
    questionText: 'الملعب مستطيل طوله ١٢ متر وعرضه ٨ متر. محيطه كم متر؟',
  ...
  // Topic 5 - Open Ended 4
  {
    ...
    questionText: 'السطح مربع طول ضلعه ٩ متر. مساحته كم متر مربع؟',
    hintText: 'مساحة المربع = الضلع × الضلع',
  ...
  // Topic 7 - MCQ 1
  {
    ...
    questionText: 'الصف الأول فيه ٢ كرسي، التاني ٥، التالت ٨. الصف الرابع فيه كم كرسي؟',
  ...
  // Topic 7 - Open Ended 2
  {
    ...
    questionText: 'الرف الأول ٥ كتب، التاني ١٠، التالت ١٥. الرف الرابع كم كتاب؟',
