...
export const level2Questions: QuestionSeed[] = [
  ...
  // Topic 1 - MCQ 2
  {
    ...
    explanation: '4/6 + 1/6 = 5/6 اتاكلوا، فالالمتبقي = 6/6 - 5/6 = 1/6',
    options: [
  ...
  // Topic 1 - MCQ 6
  {
    ...
    questionText: 'نور استخدمت 5/8 من الشريط. لو قصت أيضاً 1/8، يتبقى قد إيه؟',
  ...
  // Topic 1 - MCQ 7
  {
    ...
    questionText: 'في المرحلة الأولى كسب 4/10 وفي التانية كسب 3/10. المجموع كام؟',
  ...
  // Topic 1 - MCQ 8
  {
    ...
    questionText: 'كريم أكل 1/3 وخالد أكل 1/3. الالمتبقي قد إيه؟',
    hintText: 'اجمع اللي اتاكل واطرح من الكل',
    explanation: '1/3 + 1/3 = 2/3 اتاكلوا، فالالمتبقي = 3/3 - 2/3 = 1/3',
    options: [
  ...
  // Topic 1 - Open Ended 1
  {
    ...
    hintText: 'اجمع اللي اتاكل واطرح من 5/5',
    explanation: '2/5 + 1/5 = 3/5 اتاكلوا. الالمتبقي = 5/5 - 3/5 = 2/5. البسط = 2',
    correctAnswer: '2',
  ...
  // Topic 1 - Open Ended 2
  {
    ...
    questionText: 'لو أكلت 3/4 من الساندوتش، اطرح من الكل. البسط بتاع الكم يتبقى؟',
    hintText: '4/4 - 3/4 = ؟/4',
  ...
  // Topic 1 - Open Ended 3
  {
    ...
    questionText: 'المرة الأولى ملا 3/8 والتانية ملا 4/8. اجمع الكسرين. البسط كام؟',
  ...
  // Topic 1 - Open Ended 4
  {
    ...
    questionText: 'الأولاد أكلوا 4/6 والبنات 1/6. مجموع اللي اتاكل: البسط كام؟',
    hintText: '4 + 1 = ؟',
  ...
  // Topic 2 - MCQ 3
  {
    ...
    questionText: 'الرقم 3٫45 جنيه: الـ 4 قيمتها المكانية إيه؟',
  ...
  // Topic 2 - MCQ 6
  {
    ...
    questionText: 'سعر لتر البنزين 12٫50 جنيه. الرقم 5 في خانة إيه؟',
  ...
  // Topic 2 - Open Ended 1
  {
    ...
    questionText: 'سعر الدوا 15٫75 جنيه. الرقم 7 قيمته المكانية كام؟ اكتب الإجابة كعدد عشري.',
  ...
  // Topic 2 - Open Ended 3
  {
    ...
    questionText: 'رتّب من الأصغر للأكبر: 2٫9 ، 2٫3 ، 2٫7. العدد اللي في النص (التاني) كام؟',
  ...
  // Topic 2 - Open Ended 4
  {
    ...
    questionText: 'عند ياسمين 8٫50 جنيه. اشترت ساندوتش بـ 5٫25 جنيه. المتبقي معاها كام؟',
  ...
  // Topic 3 - MCQ 1
  {
    ...
    questionText: 'ساندوتش بـ 8٫50 جنيه وعصير بـ 4٫75 جنيه. المجموع كام؟',
  ...
  // Topic 3 - MCQ 2
  {
    ...
    questionText: 'سارة معاها 20٫00 جنيه واشترت كتاب بـ 14٫50 جنيه. الباقي كام؟',
  ...
  // Topic 3 - MCQ 3
  {
    ...
    questionText: 'جبنة بـ 12٫30 جنيه وزبدة بـ 9٫85 جنيه. المجموع كام؟',
  ...
  // Topic 3 - MCQ 4
  {
    ...
    questionText: 'عنده 50٫00 جنيه واشترى لعبة بـ 35٫75 جنيه. الباقي كام؟',
  ...
  // Topic 3 - MCQ 5
  {
    ...
    questionText: 'طماطم بـ 6٫25 جنيه وخيار بـ 3٫50 جنيه وبصل بـ 2٫75 جنيه. المجموع كام؟',
  ...
  // Topic 3 - MCQ 8
  {
    ...
    questionText: 'كان فيها 25٫40 جنيه وأضافت 12٫60 جنيه. المجموع كام؟',
  ...
  // Topic 3 - Open Ended 2
  {
    ...
    questionText: 'معاه 10٫00 جنيه واشترى عصير بـ 3٫25 جنيه وموز بـ 2٫50 جنيه. الباقي كام؟',
  ...
  // Topic 3 - Open Ended 4
  {
    ...
    questionText: 'فاتورة هذا الشهر 85٫40 جنيه والشهر اللي فات 79٫60 جنيه. مجموع الشهرين كام؟',
  ...
  // Topic 4 - MCQ 1
  {
    ...
    questionText: 'أحمد ساب البيت الساعة 7:15 ووصل المدرسة 7:45. الطريق أخد قد إيه؟',
  ...
  // Topic 4 - MCQ 2
  {
    ...
    questionText: 'الحصة بتبدأ الساعة 10:30 ومدتها 45 دقيقة. بتخلص الساعة كام؟',
  ...
  // Topic 4 - MCQ 3
  {
    ...
    questionText: 'الماتش بدأ الساعة 9:00 بالليل وخلص 10:45. مدة الماتش قد إيه؟',
  ...
  // Topic 4 - MCQ 4
  {
    ...
    questionText: 'خالد ركب المترو الساعة 8:20 والرحلة أخدت 55 دقيقة. وصل الساعة كام؟',
  ...
  // Topic 4 - MCQ 5
  {
    ...
    questionText: 'الدرس بيبدأ الساعة 4:00 ومدته ساعة ونص. بيخلص الساعة كام؟',
  ...
  // Topic 4 - MCQ 6
  {
    ...
    questionText: 'اليوم الدراسي بيبدأ 7:30 الصبح وبيخلص 1:30 الضهر. مدته كم ساعة؟',
  ...
  // Topic 4 - MCQ 8
  {
    ...
    questionText: 'حطوا الأكل في الفرن الساعة 5:40 ومحتاج ساعة و 20 دقيقة. يطلع الساعة كام؟',
  ...
  // Topic 4 - Open Ended 1
  {
    ...
    questionText: 'التمرين بيبدأ 3:30 وبيخلص 5:15. مدة التمرين كم دقيقة؟',
  ...
  // Topic 4 - Open Ended 4
  {
    ...
    questionText: 'الأتوبيس يمر عليه 6:50 الصبح والمدرسة بتبدأ 7:30. بيوصل قبل المدرسة بكم دقيقة لو الطريق 25 دقيقة؟',
  ...
  // Topic 5 - MCQ 8
  {
    ...
    questionText: 'أوضة عمر 4×3 متر وأوضة أخوه 3×3 متر. الفرق في المساحة كام؟',
  ...
  // Topic 6 - Open Ended 1
  {
    ...
    questionText: 'اشترى حاجات بـ 63 و 28 جنيه. قرّب كل عدد لأقرب عشرة واجمع. الناتج التقريبي كام؟',
  ...
  // Topic 6 - Open Ended 2
  {
    ...
    questionText: 'قرّب العدد 567 لأقرب مية. الناتج كام؟',
  ...
  // Topic 7 - MCQ 2
  {
    ...
    questionText: 'النمط: 3، 6، 12، 24، ___. العدد اللي بعد كده كام؟',
  ...
  // Topic 7 - MCQ 3
  {
    ...
    questionText: 'التسلسل: 50، 45، 40، 35، ___. العدد التالي كام؟',
  ...
  // Topic 7 - MCQ 4
  {
    ...
    questionText: 'أول يوم وزعت 1، تاني يوم 4، تالت يوم 9، رابع يوم 16. خامس يوم كام؟',
  ...
  // Topic 7 - MCQ 5
  {
    ...
    questionText: 'الرف الأول 10 أكواب، التاني 7، التالت 4. الرابع كام؟',
    hintText: 'كل رف بينقص 3',
  ...
  // Topic 7 - MCQ 6
  {
    ...
    questionText: 'التسلسل: 2، 6، 18، 54، ___. العدد التالي كام؟',
    hintText: 'كل عدد بيتضرب في 3',
  ...
  // Topic 7 - MCQ 7
  {
    ...
    questionText: 'النمط: 4، 7، 10، 13، ___. العدد اللي بعد كده كام؟',
  ...
  // Topic 7 - MCQ 8
  {
    ...
    questionText: 'أرقام البيوت: 3، 8، 13، 18، ___. البيت اللي بعد كده رقمه كام؟',
  ...
  // Topic 7 - Open Ended 1
  {
    ...
    questionText: 'أكمل النمط: 100، 90، 80، 70، ___. العدد التالي كام؟',
    hintText: 'كل مرة بينقص 10',
  ...
  // Topic 7 - Open Ended 3
  {
    ...
    questionText: 'أول أسبوع 2، تاني أسبوع 4، تالت أسبوع 8، رابع أسبوع 16. خامس أسبوع كام؟',
  ...
  // Topic 7 - Open Ended 4
  {
    ...
    questionText: 'التسلسل: 1، 4، 7، 10، 13، ___. العدد السادس كام؟',
