...
export const level1Questions: QuestionSeed[] = [
  ...
  // Topic 1 - MCQ 1
  {
    ...
    questionText: 'أحمد اشترى ساندوتش بـ ١٥ جنيه وعصير بـ ٨ جنيه. دفع كام؟',
  ...
  // Topic 1 - MCQ 8
  {
    ...
    questionText: 'مريم اشترت بلوزة بـ ١٢٠ جنيه وجيبة بـ ٩٥ جنيه. لو معاها ٢٥٠ جنيه، هيفضل كام؟',
  ...
  // Topic 1 - Open Ended 1
  {
    ...
    realLifeContext: 'خالد اشترى من الكانتين شيبسي وبسكويت',
    questionText: 'خالد اشترى شيبسي بـ ١٠ جنيه وبسكويت بـ ٧ جنيه. دفع كام في المجموع؟',
  ...
  // Topic 2 - MCQ 5
  {
    ...
    questionText: 'كل علبة ألوان بـ ١٨ جنيه وكريم عايز ٦ علب. هيدفع كام؟',
  ...
  // Topic 2 - Open Ended 1
  {
    ...
    questionText: 'كل قلم بـ ٤ جنيه وخالد عايز ٩ أقلام. هيدفع كام جنيه؟',
  ...
  // Topic 2 - Open Ended 2
  {
    ...
    questionText: 'كل زجاجة بـ ٥ جنيه والفريق ١١ لاعب. التكلفة الكلية كام جنيه؟',
  ...
  // Topic 2 - Open Ended 4
  {
    ...
    questionText: 'كل مجموعة فيها ٧ تلاميذ. كام تلميذ في الفصل كله؟',
  ...
  // Topic 3 - MCQ 1
  {
    topicIndex: 3,
    questionType: 'mcq',
    realLifeContext: 'أحمد عنده شوكولاتة وعايز يقسمها على صحابه',
    questionText: 'أحمد عنده ٢٠ قطعة شوكولاتة وعايز يقسمهم على ٤ صحاب بالتساوي. كل واحد ياخد كام؟',
  ...
  // Topic 3 - MCQ 3
  {
    topicIndex: 3,
    questionType: 'mcq',
    realLifeContext: 'كريم اشترى كيس لب وعايز يقسمه على صحابه',
    questionText: 'كريم عنده ٣٧ حبة لب وعايز يقسمهم على ٥ صحاب. كل واحد ياخد كام ويفضل كام؟',
  ...
  // Topic 3 - MCQ 7
  {
    topicIndex: 3,
    questionType: 'mcq',
    realLifeContext: 'عمر عنده ملصقات وعايز يحطهم في ألبومات',
    questionText: 'عمر عنده ٤٥ ملصق وكل صفحة بتشيل ٨ ملصقات. محتاج كام صفحة على الأقل؟',
  ...
  // Topic 3 - MCQ 8
  {
    topicIndex: 3,
    questionType: 'mcq',
    realLifeContext: 'خالد بيقسم شيبسي على أصحابه في الفسحة',
    questionText: 'خالد عنده ٤٢ كيس شيبسي وعايز يقسمهم على ٨ صحاب. كل واحد ياخد كام ويفضل كام؟',
  ...
  // Topic 3 - Open Ended 2
  {
    topicIndex: 3,
    questionType: 'open_ended',
    realLifeContext: 'أحمد بيقسم تفاح على صحابه',
    questionText: 'أحمد عنده ٢٩ تفاحة وعايز يقسمهم على ٥ صحاب. كل واحد ياخد ٥ تفاحات. الباقي كام تفاحة؟',
  ...
  // Topic 4 - MCQ 6
  {
    topicIndex: 4,
    questionType: 'mcq',
    realLifeContext: 'عمر بيكتب رقم تليفون وعايز يعرف قيمة أول رقم',
  ...
  // Topic 4 - Open Ended 2
  {
    topicIndex: 4,
    questionType: 'open_ended',
    realLifeContext: 'نور بتقرب ثمن التابلت اللي عايزاه',
  ...
  // Topic 5 - MCQ 1
  {
    ...
    hintText: 'لو الرقم زوجي يبقى يتقسم على ٢',
  ...
  // Topic 5 - Open Ended 4
  {
    ...
    questionText: 'أحمد عنده ٤٨ كرسي. لو رتبهم في صفوف كل صف ٨ كراسي، هيطلع كام صف؟',
  ...
  // Topic 6 - Open Ended 4
  {
    ...
    questionText: 'لوح شوكولاتة متقسم ١٠ مربعات. نور أكلت ٥ مربعات. أكلت كام على ١٠ من اللوح؟ (اكتب البسط)',
  ...
  // Topic 7 - MCQ 1
  {
    ...
    questionText: 'ماما اشترت ٣ كيلو تفاح و ٢ كيلو برتقال. اشترت كام كيلو فاكهة في المجموع؟',
  ...
  // Topic 7 - MCQ 2
  {
    ...
    questionText: 'طول الفصل ٨ متر وعرضه ٦ متر. المحيط كام متر؟',
  ...
  // Topic 7 - MCQ 6
  {
    ...
    questionText: 'الوصفة محتاجة لتر ونص لبن. كام مل ده؟',
  ...
  // Topic 7 - MCQ 7
  {
    ...
    questionText: 'ماما طلبت ٢ كيلو رز. كام جرام ده؟',
  ...
  // Topic 7 - MCQ 8
  {
    ...
    questionText: 'طول مريم ١٤٠ سم وطول أختها ١ متر و ٢٥ سم. الفرق كام سم؟',
  ...
  // Topic 7 - Open Ended 1
  {
    ...
    questionText: 'البطيخة وزنها ٣ كيلو. كام جرام ده؟',
    hintText: '١ كيلو = ١٠٠٠ جرام',
  ...
  // Topic 7 - Open Ended 2
  {
    ...
    questionText: 'حديقة مربعة طول ضلعها ٥ متر. المحيط كام متر؟',
  ...
  // Topic 7 - Open Ended 3
  {
    ...
    questionText: 'حوض السمك محتاج ٤ لتر مياه. كام مل ده؟',
    hintText: '١ لتر = ١٠٠٠ مل',
  ...
  // Topic 7 - Open Ended 4
  {
    ...
    questionText: 'حبل النط طوله ٢ متر و ٥٠ سم. كام سم في المجموع؟',
