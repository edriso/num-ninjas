...
export const level1Questions: QuestionSeed[] = [
  ...
  // Topic 1 - MCQ 2
  {
    ...
    questionText: 'سارة معاها 50 جنيه واشترت كراسة بـ 12 جنيه وقلم بـ 8 جنيه. المتبقي معاها كام؟',
  ...
  // Topic 1 - MCQ 3
  {
    ...
    questionText: 'كريم عنده 125 جنيه في الحصّالة وأضاف 75 جنيه. المجموع كام؟',
  ...
  // Topic 1 - MCQ 4
  {
    ...
    questionText: 'الفاتورة كانت 237 جنيه وماما دفعت 300 جنيه. الباقي كام؟',
  ...
  // Topic 1 - MCQ 5
  {
    ...
    questionText: 'عمر اشترى لعبة بـ 45 جنيه وكارت معايدة بـ 15 جنيه وكيس هدايا بـ 5 جنيه. المجموع كام؟',
  ...
  // Topic 1 - MCQ 7
  {
    ...
    questionText: 'الكانتين باع الصبح بـ 350 جنيه وبعد الضهر بـ 275 جنيه. مجموع المبيعات كام؟',
  ...
  // Topic 1 - MCQ 8
  {
    ...
    questionText: 'مريم اشترت بلوزة بـ 120 جنيه وجيبة بـ 95 جنيه. لو معاها 250 جنيه، هيتبقى كام؟',
  ...
  // Topic 1 - Open Ended 4
  {
    ...
    questionText: 'ماما اشترت خضار بـ 45 جنيه وفاكهة بـ 38 جنيه ولحمة بـ 120 جنيه. المجموع كام؟',
  ...
  // Topic 2 - MCQ 2
  {
    ...
    questionText: 'المدرّسة محتاجة 5 مجموعات تجارب، كل مجموعة بـ 25 جنيه. التكلفة كام؟',
  ...
  // Topic 2 - MCQ 3
  {
    ...
    questionText: 'كل علبة عصير بـ 7 جنيه وعمر اشترى 8 علب. الحساب كام؟',
  ...
  // Topic 2 - MCQ 4
  {
    ...
    questionText: 'تذكرة الحديقة بـ 35 جنيه وعدد التلاميذ 4. التكلفة الكلية كام؟',
  ...
  // Topic 2 - MCQ 5
  {
    ...
    questionText: 'كل علبة ألوان بـ 18 جنيه وكريم يريد 6 علب. هيكم دفع؟',
  ...
  // Topic 2 - MCQ 6
  {
    ...
    questionText: 'كل هدية بـ 40 جنيه وياسمين تريد 7 هدايا. المجموع كام؟',
  ...
  // Topic 2 - MCQ 7
  {
    ...
    questionText: 'كل دفتر بـ 15 جنيه والفصل فيه 9 تلاميذ. تكلفة الدفاتر كام؟',
  ...
  // Topic 2 - MCQ 8
  {
    ...
    questionText: 'ماما صنعت 12 صينية كعك وكل صينية محتاجة سمنة بـ 20 جنيه. تمن السمنة كلها كام؟',
  ...
  // Topic 2 - Open Ended 1
  {
    ...
    questionText: 'كل قلم بـ 4 جنيه وخالد يريد 9 أقلام. هيكم دفع جنيه؟',
  ...
  // Topic 3 - MCQ 1
  {
    ...
    questionText: 'أحمد عنده 20 قطعة فواكه ويريد يقسمهم على 4 أصدقاء بالتساوي. كل واحد يأخذ كام؟',
  ...
  // Topic 3 - MCQ 2
  {
    ...
    questionText: 'سارة عندها 25 تمرة وتريد توزعهم على 4 زميلات بالتساوي. كل واحدة تأخذ كم ويتبقى كام؟',
  ...
  // Topic 3 - MCQ 3
  {
    ...
    questionText: 'كريم عنده 37 حبة لب ويريد يقسمهم على 5 أصدقاء. كل واحد يأخذ كم ويتبقى كام؟',
  ...
  // Topic 3 - MCQ 4
  {
    ...
    questionText: 'الفصل فيه 30 تلميذ والمدرّسة تريد تقسمهم 6 فرق. كل فريق فيه كام؟',
  ...
  // Topic 3 - MCQ 5
  {
    ...
    questionText: 'نور عندها 23 موزة وتريد توزعهم على 3 إخوات. كل واحد يأخذ كم ويتبقى كام؟',
  ...
  // Topic 3 - MCQ 6
  {
    ...
    questionText: 'ياسمين أخدت عيدية 50 جنيه وتريد تقسمهم على 7 أيام. كل يوم تصرف كم ويتبقى كام؟',
  ...
  // Topic 3 - MCQ 8
  {
    ...
    questionText: 'خالد عنده 42 كيس تفاح ويريد يقسمهم على 8 أصدقاء. كل واحد يأخذ كم ويتبقى كام؟',
  ...
  // Topic 3 - Open Ended 1
  {
    ...
    questionText: 'مريم عندها 36 حلاوة وتريد توزعهم على 6 أصدقاء بالتساوي. كل واحدة تأخذ كام؟',
    hintText: 'اقسم 36 على 6',
    explanation: '36 ÷ 6 = 6 حلاوات لكل واحدة',
    correctAnswer: '6',
  ...
  // Topic 4 - MCQ 1
  {
    ...
    questionText: 'العداد بيقول 24٬857 كيلومتر. الرقم 4 قيمته المكانية كام؟',
  ...
  // Topic 4 - MCQ 6
  {
    ...
    questionText: 'في العدد 72٬456، الرقم 7 قيمته المكانية كام؟',
  ...
  // Topic 4 - Open Ended 1
  {
    ...
    questionText: 'في العدد 6٬382، الرقم 3 قيمته المكانية كام؟',
  ...
  // Topic 5 - MCQ 2
  {
    ...
    questionText: 'إيه عوامل العدد 12؟',
  ...
  // Topic 5 - MCQ 6
  {
    ...
    questionText: 'إيه أول 3 مضاعفات للعدد 9؟',
  ...
  // Topic 5 - Open Ended 1
  {
    ...
    questionText: 'إيه ناتج 8 × 7؟ (وهو مضاعف مشترك لـ 8 و 7)',
  ...
  // Topic 5 - Open Ended 3
  {
    ...
    questionText: 'إيه خامس مضاعف للعدد 4؟',
    hintText: 'اضرب 4 × 5',
  ...
  // Topic 6 - MCQ 6
  {
    ...
    questionText: 'لوح الفواكه متقسم 12 مربع. ياسمين أكلت 4 مربعات. أكلت قد إيه؟',
  ...
  // Topic 6 - MCQ 8
  {
    ...
    questionText: 'خالد أكل 2/8 وأخوه أكل 2/8. المتبقي قد إيه؟',
    hintText: 'اجمع اللي اتاكل واطرح من 8/8',
    explanation: '2/8 + 2/8 = 4/8. الالمتبقي = 8/8 - 4/8 = 4/8 = 1/2',
    options: [
  ...
  // Topic 6 - Open Ended 1
  {
    ...
    questionText: 'أحمد أكل 2 حتة من 6. البسط في الكسر هذا كام؟',
  ...
  // Topic 6 - Open Ended 2
  {
    ...
    questionText: 'بسطي الكسر 4/8. المقام في أبسط صورة كام؟',
  ...
  // Topic 6 - Open Ended 3
  {
    ...
    questionText: 'لو الكيكة كلها متقسمة 5 حتت، الكيكة كاملة بتتكتب كسر إزاي؟ البسط كام؟',
  ...
  // Topic 7 - MCQ 3
  {
    ...
    explanation: '3 زجاجات × 0.5 لتر = 1.5 لتر. الالمتبقي = 5 - 1.5 = 3.5 لتر',
    options: [
  ...
  // Topic 7 - MCQ 4
  {
    ...
    questionText: 'شنطة أحمد وزنها 4 كيلو. لو حط فيها كتاب وزنه 500 جرام، الوزن الكلي كام؟',
