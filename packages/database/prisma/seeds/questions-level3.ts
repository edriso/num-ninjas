...
export const level3Questions: QuestionSeed[] = [
  ...
  // --- Topic 2, MCQ 1 ---
  {
    topicIndex: 2,
    questionType: 'mcq',
    realLifeContext: 'ماما صنعت بسبوسة وتريد تأخذ ٢/٣ الوصفة. الوصفة الأصلية محتاجة ٣/٤ كوباية سكر.',
  ...
  // --- Topic 2, MCQ 3 ---
  {
    topicIndex: 2,
    questionType: 'mcq',
    realLifeContext: 'عندك ٣/٥ كيلو فواكه ويريد توزع ١/٣ منها على أصدقاءك في المدرسة.',
  ...
  // --- Topic 2, MCQ 8 ---
  {
    topicIndex: 2,
    questionType: 'mcq',
    realLifeContext: 'عندك ٧/٨ لتر عصير ليمون وتحتاج أن تأخذ ٢/٣ منه تحطه في الثلاجة.',
  ...
  // --- Topic 2, Open-ended 2 ---
  {
    topicIndex: 2,
    questionType: 'open_ended',
    realLifeContext: 'بابا اشترى ٤ أمتار قماش ويريد يستخدم ٣/٨ منهم لستارة الصالون.',
  ...
  // --- Topic 3, MCQ 1 ---
  {
    topicIndex: 3,
    questionType: 'mcq',
    realLifeContext: 'عندك ٣/٤ كيلو حلاوة طحينية ويريد تقسمها على ٣ أأصدقاء بالتساوي.',
  ...
  // --- Topic 3, MCQ 3 ---
  {
    topicIndex: 3,
    questionType: 'mcq',
    realLifeContext: 'عندك ٤/٥ كيلو فول سوداني ويريد تحط في كل كيس ٢/٥ كيلو.',
  ...
  // --- Topic 3, MCQ 5 ---
  {
    topicIndex: 3,
    questionType: 'mcq',
    realLifeContext: 'عندك ٧/٨ كيلو جبنة ويريد تقسمها على ٧ ساندويتشات بالتساوي.',
  ...
  // --- Topic 3, Open-ended 2 ---
  {
    topicIndex: 3,
    questionType: 'open_ended',
    realLifeContext: 'عندك ٥/٨ كيلو مكسرات ويريد تحط في كل كيس ١/٤ كيلو.',
  ...
  // --- Topic 6, MCQ 1 ---
  {
    topicIndex: 6,
    questionType: 'mcq',
    realLifeContext: 'بابا اشترى ٣ علب عصير بـ ٥ جنيه الواحدة وكيس تفاح بـ ٨ جنيه.',
  ...
  // --- Topic 7, MCQ 6 ---
  {
    topicIndex: 7,
    questionType: 'mcq',
    realLifeContext: 'بابا يريد يعمل ميزانية شهرية. المرتب ٨٠٠٠ جنيه. الإيجار ٣٠٠٠، الأكل ٢٥٠٠، المواصلات ١٠٠٠.',
